...
### Motivation
  ...
  * C wurde entwickelt, um das Betriebssystem UNIX zu schreiben und bot im Vergleich zu Assemblersprachen eine höhere Abstraktion und Portabilität.

### Auswirkungen

  * C war fundamental für die Entwicklung vieler Betriebssysteme und hat eine Reihe anderer Programmiersprachen beeinflusst, einschließlich seines direkten Nachfolgers C++.
...
*Abbildung* 1: Der Erfinder von C: *Dennis Ritchie* (rechts), zusamme mit *Ken Thompson*.
